...
// This file implements WiFi signal strength monitoring via a CoreWLAN-based
// Swift helper binary, replacing the deprecated macOS airport CLI utility.
package collector
...
// On macOS, it uses the wifi-helper binary (CoreWLAN-based Swift tool).
// On other platforms, it returns a zero-value WifiInfo with no error.
